...
from scoring_hill import score
...
def score_wrapper_2i(log_alpha_X: float, log_alpha_Y: float, log_beta_X: float,
                     log_beta_Y: float, log_z_X: float, log_x_Y: float,
                     log_x_Z: float, log_y_Z: float) -> float:
    ...
    par_dict = {
        "delta_Y": 1,
        "delta_Z": 1,
        "alpha_X": 10**log_alpha_X,
        "alpha_Y": 10**log_alpha_Y,
        "beta_X": 10**log_beta_X,
        "beta_Y": 10**log_beta_Y,
        "z_X": 10**log_z_X,
        "x_Y": 10**log_x_Y,
        "x_Z": 10**log_x_Z,
        "y_Z": 10**log_y_Z,
...
def score_wrapper_1i(log_alpha_X: float, log_alpha_Y: float, log_beta_X: float,
                     log_z_X: float, log_x_Y: float, log_x_Z: float,
                     log_y_Z: float) -> float:
    """Wrapper function two-inducer model, to be called by the optimiser."""
    #pylint: disable=too-many-arguments
